...
public class ModuleDtoMapper {
    ...
    public ModuleDto moduleToModuleDto(Module module) {
        return ModuleDto.builder()
                ...
                .notes(this.noteDtoMapper.noteListToNoteDtoList(module.getNotes()))
                .build();
    }
    ...
    public Module moduleDtoToModule(ModuleDto moduleDto) {
        return Module.builder()
                ...
                .sumNote(this.calculteAverageNoteFromList(moduleDto.getNotes()))
                .notes(this.noteDtoMapper.noteDtoListToNoteList(moduleDto.getNotes()))
                .build();
    }
